...
public slots:
    ...
    void parseCurrenciesBittrex(QString data);
    void parseCurrenciesMintpal(QString data);
    void updateCurrencies();
    void updateCurrenciesMi();
    void onListCurrencieItemClicked(QString item);
    void onListCurrencieItemClickedMi(QString item);
